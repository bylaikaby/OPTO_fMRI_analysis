function hout=suptitle(str,COLOR,SIZE,FONTWEIGHT)
...
ht=text(.5,titleypos-1,str,'interpreter','none','color',COLOR);
set(ht,'horizontalalignment','center','fontsize',fs,'fontweight',FONTWEIGHT);
set(gcf,'nextplot',np);
axes(haold);
if nargout,
	hout=ht;
