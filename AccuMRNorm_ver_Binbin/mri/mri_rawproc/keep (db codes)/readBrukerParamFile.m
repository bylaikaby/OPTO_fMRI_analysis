...
% espacially: acqp and method files.
%
  % Usage: [paramStruct,headers]=read_AcqpFile(filename)
%
...
%
%
% Requiremts: the function reads the first 5 lines as headerinformation
% and the 2 following lines of comments as addintional headerinformation.
...
% All Rights Reserved
%
% $Id: readBrukerParamFile.m,v 1.2 2012/09/21 09:46:44 josh Exp $
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% ... or a simple array (most frequently numeric)
    ...
    %disp(data); disp(size(values)); disp([fliplr(sizes) 1]); 
