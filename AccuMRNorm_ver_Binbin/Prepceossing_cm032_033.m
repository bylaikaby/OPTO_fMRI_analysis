...
orig_dataset2convert = 'D:\CM033.zJ1';
[main_dir,orig_dataset_name,ext] = fileparts(orig_dataset2convert);
bids_name = [orig_dataset_name,'_','bids_new'];
...
run_bet4animal_macaque('/home/bb/fsl',par.ana,par.pathana,0.35);
...
%% %% Segmentation 
mancoreg(par.temp_fulldir,par.ana)
