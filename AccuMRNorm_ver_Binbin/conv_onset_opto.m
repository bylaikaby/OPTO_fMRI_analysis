...
analysis_dir = 'D:\CM032_bids_NEW\sub-CM032\first_level_analysis';
% define the run ids to get the onset times.
mkdir(analysis_dir)
num_runs=[12,15,17,18,20,22:28,32,33,38:41,47:51,42:44,55:56];
...
%     dgz_file = 'cm32Aw1_012.dgz';
    ...
    onset_times{1}(end+1)= onset_times{3}(end)+28;
