...
PSF = reshape(single(resample(double(subVec(permute(PSF,[2 4 1 3]))),ups,1)),[ny*ups ny*nz*nx]);
EPI = reshape(single(resample(double(subVec(permute(EPI,[2 1 3 4]))),ups,1)),[ny*ups*nx*nz nr]);
